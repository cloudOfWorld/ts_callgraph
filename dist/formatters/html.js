 ...
 */
class HtmlFormatter extends base_1.BaseFormatter {
    /**
     * 格式化为HTML报告
     */
    format(result) {
...
<body>
     ...
     * 生成类图标签页
     */
    generateClassDiagramTab(result) {
        return `
     ...
     * 生成Mermaid类图
     */
    generateMermaidClassDiagram(result) {
     ...
     * 获取Mermaid可见性符号
     */
    getMermaidVisibility(accessibility) {
